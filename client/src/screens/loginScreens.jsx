...
<div className="w-1/2 h-screen bg-black">
    <div className="flex flex-col justify-center w-2/3 h-full mx-auto text-white xl:w-1/2">
      ...
      <div className="my-6">
        <button className="flex justify-center w-full p-1 text-black bg-white border-none rounded-3xl hover:bg-gray-200 sm:p-2"><img src="https://freesvg.org/img/1534129544.png" class="mr-2 w-6 object-fill" />Sign in with Google</button>
      </div>
      <div>
        <fieldset className="border-t border-gray-600 border-solid">
          <legend className="px-2 mx-auto text-sm text-center">Or login via our secure system</legend>
        </fieldset>
      </div>
      <div className="mt-10">
        <form>
          ...
          <div className="my-10">
            <button className="w-full p-5 bg-orange-600 rounded-full hover:bg-orange-800">Login</button>
          </div>
        </form>
      </div>
    </div>
